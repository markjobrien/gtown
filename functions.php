...
add_action( 'wp_enqueue_scripts', 'add_libraries', 999 );
...
function add_libraries() {
	...
	if ( is_page('Admin') ) {
		...
		wp_enqueue_script( 'jquery-ui', get_template_directory_uri() . '/js/jquery-ui.min.js', '', '', true );
...
function twentytwelve_scripts_styles() {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'twentytwelve' ) ) {
		...
		$query_args = array(
			'family' => 'Open+Sans:400italic,700italic,200,300,400,500,600,700',
			'subset' => $subsets,
		);
...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Inside Sidebar', 'twentytwelve' ),
		'id' => 'sidebar-2',
	...
	register_sidebar( array(
		'name' => __( 'Home Footer', 'twentytwelve' ),
		'id' => 'sidebar-4',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Inside Footer', 'twentytwelve' ),
		'id' => 'sidebar-5',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
...
function results_shortcode( $atts ){
	$is_admin = 0;
	$results = 1;
	return display_matches( $is_admin, $results, $atts['year'] );
}
add_shortcode( 'display_results', 'results_shortcode' );
